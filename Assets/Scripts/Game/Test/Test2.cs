...
public class Test2 : MonoBehaviour
{
    ...
    // Boþluklar
    [SerializeField] float topOffset = 100.0f; // Ekranýn üstünden aþaðýya býrakmak istediðin mesafe (örneðin, 100 birim)
    [SerializeField] float bottomOffset = 50.0f; // Ekranýn altýndan yukarýya býrakmak istediðin mesafe (örneðin, 50 birim)
    ...
    private void Start()
    {
        ...
        // Hücre boyutlarýný hesapla (geniþlik ekran geniþliðine sýðmalý)
        ...
        Vector3 gridStartPos = new Vector3(
            topLeftWorld.x, // X pozisyonu: ekranýn sol kenarýndan baþlýyor
            topLeftWorld.y - topOffset, // Y pozisyonu: yukarýdan topOffset kadar aþaðýya iniyor
            topLeftWorld.z
        );
